...
interface C132Props {
  ...
  allAnswers: Input132Type[];
  setAllAnswers: React.Dispatch<React.SetStateAction<Input132Type[]>>;
  isSolved: boolean;
  handleCorrectChange: (qId: number, pass: boolean) => void;
}

export default function C132(props: C132Props) {
