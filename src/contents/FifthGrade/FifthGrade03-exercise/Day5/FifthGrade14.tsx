...
const FifthGrade14: React.FC = () => {
  ...
  useEffect(() => {
    const loadChanges = async () => {
      try {
        const savedAnswers = await getKeyValue({ key: 'fifthGrade44Answers' });
        if (savedAnswers) {
    ...
    <Styled.OneToNine className="sectionSize">
      <div className="exampleBox312">
        <div className="fontSize17">
          분자의 두 수가 분모의 두 수보다 같게 만들기 더 쉬운 경우 분자를 같게
          한 다음 크기를 비교합니다.
        </div>
        <div></div>
      ...
      <div className="quizRow3case minwidwer900px">
        <div className="flexRow fontSize17 justifyCenter mairgin-wef">
          ...
          <div className="fontSize14 marginlR10px">
            <div className="textCenter colrrwrinput">2</div>
            <div className="divlineCSS11 arfgawefawbort"></div>
            <div className="textCenter colrrwrinput">5</div>
          </div>
          <input type="text" value=">" className="awefinbptu" />
          <div className="fontSize14 marginRighttic">
            <div className="textCenter colrrwrinput">2</div>
            <div className="divlineCSS11 arfgawefawbort"></div>
            <div className="textCenter colrrwrinput">6</div>
          </div>
        </div>
        <div className="flexRow fontSize17 justifyCenter">
          <p className="fontSize20 afwe3513">
